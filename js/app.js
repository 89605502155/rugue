...
document.addEventListener('DOMContentLoaded', (_event) => {
    ...
    let stone = new Block(Material.StaticStone, 500, 10, 50, 150);
    let isPaintStone = mapField.appendObjectBuild(stone);
    let stone2 = new Block(Material.StaticStone, 1000, 10, 50, 150);
    mapField.appendObjectBuild(stone2);
    let stone3 = new Block(Material.StaticStone, 0, 0, 50, canvas.height);
    mapField.appendObjectBuild(stone3);
    let stone4 = new Block(Material.StaticStone, canvas.width - 50, 0, 50, canvas.height);
    mapField.appendObjectBuild(stone4);
    let stone5 = new Block(Material.StaticStone, 0, 0, canvas.width, 40);
    mapField.appendObjectBuild(stone5);
    let stone6 = new Block(Material.StaticStone, 0, canvas.height - 50, canvas.width, 50);
...
function generatePlayer() {
    ...
    const user = new User({ roadToPicture: userSrc, x: 60,
